...
`,[$("scrollbar",`
 ...
 `,[$("base-loading",`
 color: var(--n-loading-color);
 `),$("base-selection-tags","min-height: var(--n-height);"),H("border, state-border",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
 ...
 `),$("base-selection-label","background-color: var(--n-color-active);"),$("base-selection-tags","background-color: var(--n-color-active);")])]),ee("disabled","cursor: not-allowed;",[H("arrow",`
 ...
 `),$("base-selection-label",`background-color: var(--n-color-active-${e});`),$("base-selection-tags",`background-color: var(--n-color-active-${e});`)]),ee("focus",[H("state-border",`
 ...
 `,[kn({originalTransition:"background-color .3s var(--n-bezier), box-shadow .3s var(--n-bezier)"})])]),ci=Object.assign(Object.assign({},fe.props),{to:yn.propTo,bordered:{type:Boolean,default:void 0},clearable:Boolean,clearFilterAfterSelect:{type:Boolean,default:!0},options:{type:Array,default:()=>[]},defaultValue:{type:[String,Number,Array],default:null},keyboard:{type:Boolean,default:!0},value:[String,Number,Array],placeholder:String,menuProps:Object,multiple:Boolean,size:String,filterable:Boolean,disabled:{type:Boolean,default:void 0},remote:Boolean,loading:Boolean,filter:Function,placement:{type:String,default:"bottom-start"},widthMode:{type:String,default:"trigger"},tag:Boolean,onCreate:Function,fallbackOption:{type:[Function,Boolean],default:void 0},show:{type:Boolean,default:void 0},showArrow:{type:Boolean,default:!0},maxTagCount:[Number,String],ellipsisTagPopoverProps:Object,consistentMenuWidth:{type:Boolean,default:!0},virtualScroll:{type:Boolean,default:!0},labelField:{type:String,default:"label"},valueField:{type:String,default:"value"},childrenField:{type:String,default:"children"},renderLabel:Function,renderOption:Function,renderTag:Function,"onUpdate:value":[Function,Array],inputProps:Object,nodeProps:Function,ignoreComposition:{type:Boolean,default:!0},showOnFocus:Boolean,onUpdateValue:[Function,Array],onBlur:[Function,Array],onClear:[Function,Array],onFocus:[Function,Array],onScroll:[Function,Array],onSearch:[Function,Array],onUpdateShow:[Function,Array],"onUpdate:show":[Function,Array],displayDirective:{type:String,default:"show"},resetMenuOnOptionsChange:{type:Boolean,default:!0},status:String,showCheckmark:{type:Boolean,default:!0},onChange:[Function,Array],items:Array}),Ti=ie({name:"Select",props:ci,setup(e){const{mergedClsPrefixRef:n,mergedBorderedRef:t,namespaceRef:o,inlineThemeDisabled:i}=Ie(e),r=fe("Select","-select",ui,no,e,n),l=E(e.defaultValue),a=ne(e,"value"),u=mn(a,l),h=E(!1),c=E(""),p=F(()=>{const{valueField:s,childrenField:w}=e,K=ai(s,w);return rt(v.value,K)}),O=F(()=>di(j.value,e.valueField,e.childrenField)),_=E(!1),b=mn(ne(e,"show"),_),k=E(null),B=E(null),z=E(null),{localeRef:M}=Xn("Select"),N=F(()=>{var s;return(s=e.placeholder)!==null&&s!==void 0?s:M.value.placeholder}),m=go(e,["items","options"]),S=[],L=E([]),D=E([]),q=E(new Map),Z=F(()=>{const{fallbackOption:s}=e;if(s===void 0){const{labelField:w,valueField:K}=e;return X=>({[w]:String(X),[K]:X})}return s===!1?!1:w=>Object.assign(s(w),{value:w})}),j=F(()=>D.value.concat(L.value).concat(m.value)),y=F(()=>{const{filter:s}=e;if(s)return s;const{labelField:w,valueField:K}=e;return(X,G)=>{if(!G)return!1;const W=G[w];if(typeof W=="string")return gn(X,W);const U=G[K];return typeof U=="string"?gn(X,U):typeof U=="number"?gn(X,String(U)):!1}}),v=F(()=>{if(e.remote)return m.value;{const{value:s}=j,{value:w}=c;return!w.length||!e.filterable?s:si(s,y.value,w,e.childrenField)}});function x(s){const w=e.remote,{value:K}=q,{value:X}=O,{value:G}=Z,W=[];return s.forEach(U=>{if(X.has(U))W.push(X.get(U));else if(w&&K.has(U))W.push(K.get(U));else if(G){const re=G(U);re&&W.push(re)}}),W}const T=F(()=>{if(e.multiple){const{value:s}=u;return Array.isArray(s)?x(s):[]}return null}),I=F(()=>{const{value:s}=u;return!e.multiple&&!Array.isArray(s)?s===null?null:x([s])[0]||null:null}),V=Yt(e),{mergedSizeRef:R,mergedDisabledRef:A,mergedStatusRef:Q}=V;function J(s,w){const{onChange:K,"onUpdate:value":X,onUpdateValue:G}=e,{nTriggerFormChange:W,nTriggerFormInput:U}=V;K&&ce(K,s,w),G&&ce(G,s,w),X&&ce(X,s,w),l.value=s,W(),U()}function ae(s){const{onBlur:w}=e,{nTriggerFormBlur:K}=V;w&&ce(w,s),K()}function f(){const{onClear:s}=e;s&&ce(s)}function C(s){const{onFocus:w,showOnFocus:K}=e,{nTriggerFormFocus:X}=V;w&&ce(w,s),X(),K&&be()}function te(s){const{onSearch:w}=e;w&&ce(w,s)}function he(s){const{onScroll:w}=e;w&&ce(w,s)}function we(){var s;const{remote:w,multiple:K}=e;if(w){const{value:X}=q;if(K){const{valueField:G}=e;(s=T.value)===null||s===void 0||s.forEach(W=>{X.set(W[G],W)})}else{const G=I.value;G&&X.set(G[e.valueField],G)}}}function Y(s){const{onUpdateShow:w,"onUpdate:show":K}=e;w&&ce(w,s),K&&ce(K,s),_.value=s}function be(){A.value||(Y(!0),_.value=!0,e.filterable&&We())}function ue(){Y(!1)}function Te(){c.value="",D.value=S}const xe=E(!1);function Me(){e.filterable&&(xe.value=!0)}function Ne(){e.filterable&&(xe.value=!1,b.value||Te())}function Ae(){A.value||(b.value?e.filterable?We():ue():be())}function Be(s){var w,K;!((K=(w=z.value)===null||w===void 0?void 0:w.selfRef)===null||K===void 0)&&K.contains(s.relatedTarget)||(h.value=!1,ae(s),ue())}function ke(s){C(s),h.value=!0}function Pe(s){h.value=!0}function $e(s){var w;!((w=k.value)===null||w===void 0)&&w.$el.contains(s.relatedTarget)||(h.value=!1,ae(s),ue())}function Ee(){var s;(s=k.value)===null||s===void 0||s.focus(),ue()}function Le(s){var w;b.value&&(!((w=k.value)===null||w===void 0)&&w.$el.contains(to(s))||ue())}function Fe(s){if(!Array.isArray(s))return[];if(Z.value)return Array.from(s);{const{remote:w}=e,{value:K}=O;if(w){const{value:X}=q;return s.filter(G=>K.has(G)||X.has(G))}else return s.filter(X=>K.has(X))}}function Oe(s){de(s.rawNode)}function de(s){if(A.value)return;const{tag:w,remote:K,clearFilterAfterSelect:X,valueField:G}=e;if(w&&!K){const{value:W}=D,U=W[0]||null;if(U){const re=L.value;re.length?re.push(U):L.value=[U],D.value=S}}if(K&&q.value.set(s[G],s),e.multiple){const W=Fe(u.value),U=W.findIndex(re=>re===s[G]);if(~U){if(W.splice(U,1),w&&!K){const re=g(s[G]);~re&&(L.value.splice(re,1),X&&(c.value=""))}}else W.push(s[G]),X&&(c.value="");J(W,x(W))}else{if(w&&!K){const W=g(s[G]);~W?L.value=[L.value[W]]:L.value=S}He(),ue(),J(s[G],s)}}function g(s){return L.value.findIndex(K=>K[e.valueField]===s)}function P(s){b.value||be();const{value:w}=s.target;c.value=w;const{tag:K,remote:X}=e;if(te(w),K&&!X){if(!w){D.value=S;return}const{onCreate:G}=e,W=G?G(w):{[e.labelField]:w,[e.valueField]:w},{valueField:U,labelField:re}=e;m.value.some(ve=>ve[U]===W[U]||ve[re]===W[re])||L.value.some(ve=>ve[U]===W[U]||ve[re]===W[re])?D.value=S:D.value=[W]}}function oe(s){s.stopPropagation();const{multiple:w}=e;!w&&e.filterable&&ue(),f(),w?J([],[]):J(null,null)}function rn(s){!ze(s,"action")&&!ze(s,"empty")&&s.preventDefault()}function ln(s){he(s)}function Ve(s){var w,K,X,G,W;if(!e.keyboard){s.preventDefault();return}switch(s.key){case" ":if(e.filterable)break;s.preventDefault();case"Enter":if(!(!((w=k.value)===null||w===void 0)&&w.isComposing)){if(b.value){const U=(K=z.value)===null||K===void 0?void 0:K.getPendingTmNode();U?Oe(U):e.filterable||(ue(),He())}else if(be(),e.tag&&xe.value){const U=D.value[0];if(U){const re=U[e.valueField],{value:ve}=u;e.multiple&&Array.isArray(ve)&&ve.some(dn=>dn===re)||de(U)}}}s.preventDefault();break;case"ArrowUp":if(s.preventDefault(),e.loading)return;b.value&&((X=z.value)===null||X===void 0||X.prev());break;case"ArrowDown":if(s.preventDefault(),e.loading)return;b.value?(G=z.value)===null||G===void 0||G.next():be();break;case"Escape":b.value&&(oo(s),ue()),(W=k.value)===null||W===void 0||W.focus();break}}function He(){var s;(s=k.value)===null||s===void 0||s.focus()}function We(){var s;(s=k.value)===null||s===void 0||s.focusInput()}function an(){var s;b.value&&((s=B.value)===null||s===void 0||s.syncPosition())}we(),ye(ne(e,"options"),we);const sn={focus:()=>{var s;(s=k.value)===null||s===void 0||s.focus()},focusInput:()=>{var s;(s=k.value)===null||s===void 0||s.focusInput()},blur:()=>{var s;(s=k.value)===null||s===void 0||s.blur()},blurInput:()=>{var s;(s=k.value)===null||s===void 0||s.blurInput()}},Ge=F(()=>{const{self:{menuBoxShadow:s}}=r.value;return{"--n-menu-box-shadow":s}}),Se=i?_e("select",void 0,Ge,e):void 0;return Object.assign(Object.assign({},sn),{mergedStatus:Q,mergedClsPrefix:n,mergedBordered:t,namespace:o,treeMate:p,isMounted:Jt(),triggerRef:k,menuRef:z,pattern:c,uncontrolledShow:_,mergedShow:b,adjustedTo:yn(e),uncontrolledValue:l,mergedValue:u,followerRef:B,localizedPlaceholder:N,selectedOption:I,selectedOptions:T,mergedSize:R,mergedDisabled:A,focused:h,activeWithoutMenuOpen:xe,inlineThemeDisabled:i,onTriggerInputFocus:Me,onTriggerInputBlur:Ne,handleTriggerOrMenuResize:an,handleMenuFocus:Pe,handleMenuBlur:$e,handleMenuTabOut:Ee,handleTriggerClick:Ae,handleToggle:Oe,handleDeleteOption:de,handlePatternInput:P,handleClear:oe,handleTriggerBlur:Be,handleTriggerFocus:ke,handleKeydown:Ve,handleMenuAfterLeave:Te,handleMenuClickOutside:Le,handleMenuScroll:ln,handleMenuKeydown:Ve,handleMenuMousedown:rn,mergedTheme:r,cssVars:i?void 0:Ge,themeClass:Se==null?void 0:Se.themeClass,onRender:Se==null?void 0:Se.onRender})},render(){return d("div",{class:`${this.mergedClsPrefix}-select`},d(Jn,null,{default:()=>[d(Qn,null,{default:()=>d(li,{ref:"triggerRef",inlineThemeDisabled:this.inlineThemeDisabled,status:this.mergedStatus,inputProps:this.inputProps,clsPrefix:this.mergedClsPrefix,showArrow:this.showArrow,maxTagCount:this.maxTagCount,ellipsisTagPopoverProps:this.ellipsisTagPopoverProps,bordered:this.mergedBordered,active:this.activeWithoutMenuOpen||this.mergedShow,pattern:this.pattern,placeholder:this.localizedPlaceholder,selectedOption:this.selectedOption,selectedOptions:this.selectedOptions,multiple:this.multiple,renderTag:this.renderTag,renderLabel:this.renderLabel,filterable:this.filterable,clearable:this.clearable,disabled:this.mergedDisabled,size:this.mergedSize,theme:this.mergedTheme.peers.InternalSelection,labelField:this.labelField,valueField:this.valueField,themeOverrides:this.mergedTheme.peerOverrides.InternalSelection,loading:this.loading,focused:this.focused,onClick:this.handleTriggerClick,onDeleteOption:this.handleDeleteOption,onPatternInput:this.handlePatternInput,onClear:this.handleClear,onBlur:this.handleTriggerBlur,onFocus:this.handleTriggerFocus,onKeydown:this.handleKeydown,onPatternBlur:this.onTriggerInputBlur,onPatternFocus:this.onTriggerInputFocus,onResize:this.handleTriggerOrMenuResize,ignoreComposition:this.ignoreComposition},{arrow:()=>{var e,n;return[(n=(e=this.$slots).arrow)===null||n===void 0?void 0:n.call(e)]}})}),d(et,{ref:"followerRef",show:this.mergedShow,to:this.adjustedTo,teleportDisabled:this.adjustedTo===yn.tdkey,containerClass:this.namespace,width:this.consistentMenuWidth?"target":void 0,minWidth:"target",placement:this.placement},{default:()=>d(Rn,{name:"fade-in-scale-up-transition",appear:this.isMounted,onAfterLeave:this.handleMenuAfterLeave},{default:()=>{var e,n,t;return this.mergedShow||this.displayDirective==="show"?((e=this.onRender)===null||e===void 0||e.call(this),Qt(d(ii,Object.assign({},this.menuProps,{ref:"menuRef",onResize:this.handleTriggerOrMenuResize,inlineThemeDisabled:this.inlineThemeDisabled,virtualScroll:this.consistentMenuWidth&&this.virtualScroll,class:[`${this.mergedClsPrefix}-select-menu`,this.themeClass,(n=this.menuProps)===null||n===void 0?void 0:n.class],clsPrefix:this.mergedClsPrefix,focusable:!0,labelField:this.labelField,valueField:this.valueField,autoPending:!0,nodeProps:this.nodeProps,theme:this.mergedTheme.peers.InternalSelectMenu,themeOverrides:this.mergedTheme.peerOverrides.InternalSelectMenu,treeMate:this.treeMate,multiple:this.multiple,size:"medium",renderOption:this.renderOption,renderLabel:this.renderLabel,value:this.mergedValue,style:[(t=this.menuProps)===null||t===void 0?void 0:t.style,this.cssVars],onToggle:this.handleToggle,onScroll:this.handleMenuScroll,onFocus:this.handleMenuFocus,onBlur:this.handleMenuBlur,onKeydown:this.handleMenuKeydown,onTabOut:this.handleMenuTabOut,onMousedown:this.handleMenuMousedown,show:this.mergedShow,showCheckmark:this.showCheckmark,resetMenuOnOptionsChange:this.resetMenuOnOptionsChange}),{empty:()=>{var o,i;return[(i=(o=this.$slots).empty)===null||i===void 0?void 0:i.call(o)]},header:()=>{var o,i;return[(i=(o=this.$slots).header)===null||i===void 0?void 0:i.call(o)]},action:()=>{var o,i;return[(i=(o=this.$slots).action)===null||i===void 0?void 0:i.call(o)]}}),this.displayDirective==="show"?[[eo,this.mergedShow],[Mn,this.handleMenuClickOutside,void 0,{capture:!0}]]:[[Mn,this.handleMenuClickOutside,void 0,{capture:!0}]])):null}})})]}))}}),at=ie({name:"DropdownDivider",props:{clsPrefix:{type:String,required:!0}},render(){return d("div",{class:`${this.clsPrefix}-dropdown-divider`})}}),fi=$("icon",`
 height: 1em;
 width: 1em;
 line-height: 1em;
 text-align: center;
